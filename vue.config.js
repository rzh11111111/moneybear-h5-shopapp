...
module.exports = {
    ...
    chainWebpack: (config) => {
        config.resolve.alias
            ...
            .set('@pageShop', resolve('src/views/shopApp/pageShop'))
            .set('@pageProm', resolve('src/views/promoteApp/pageProm'))
        if (env === 'production') {
            config.optimization.minimize(true); //.js,css代码的最小化压缩和分割
        }
             // svg loader
            ...
            imagesRule.exclude.add(resolves('src/icons'))
            config.module
            .rule('images')
