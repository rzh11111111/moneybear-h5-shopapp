<template>
  <div class="login-all" id="login-box">
    ...
    <div class="anzhuotop">
      ...
      <!-- <div class="login-choose" v-if="choosetype==1">
            <div class="login-onoff login-on"></div>
            <div class="loginbtn btn1 white" @click="logincut(1)">
               
                <svg-icon icon-class="login-shop"/>
                <p>店主登录</p>
            </div>

            <div class="loginbtn btn2" @click="logincut(2)">
                <div><img src="@/assets/img/index/promote2.png"></div>
                <p>推广登录</p>
            </div>

        </div>
        <div class="login-choose" v-else>
            <div class="login-onoff login-off"></div>
            <div class="loginbtn btn1" @click="logincut(1)">
                <div><img src="@/assets/img/index/shop2.png"></div>
                <p>店主登录</p>
            </div>

            <div class="loginbtn btn2 white" @click="logincut(2)">
                <div><img src="@/assets/img/index/promote.png"></div>
                <p>推广登录</p>
            </div>
...
<script>
import { inputup, back, inputup2, appUpdate } from "@utils";
...
export default {
  data () {
    return {
      ...
      password: '',
      loginwarn: '',
      choosetype: 2, // 选择去商户还是推广，1商户，2推广
      userfocus: '',
      passfocus: '',
      eyes: 'login-eyeoff',
      warn: false,
