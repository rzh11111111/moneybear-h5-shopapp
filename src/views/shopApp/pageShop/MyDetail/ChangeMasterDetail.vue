  ...
  <div class="app-init">
    ...
    <van-collapse v-model="activeNames" class="margintop">
      <van-collapse-item name="2" title="商户老板证照信息" value-class="collapsewarn">
        ...
        />
        <van-field type="text" label="身份证号" :value="approvalContent.idCard" readonly />
        <van-field
          type="text"
          style="margin-left:12px;"
        ...
        <van-cell
          title
          value-class="teadd"
          v-if="approvalContentSuccess!=null && (change(approvalContent.idCardJustUrl,approvalContentSuccess.idCardJustUrl) || change(approvalContent.idCardBackUrl,approvalContentSuccess.idCardBackUrl))"
        >
    ...
    <van-collapse v-model="activeNames" class="margintop">
      <van-collapse-item
        ...
        v-if="approvalContent.storeList[index].bcUserIdCard != approvalContent.idCard && approvalContent.storeList[index].bcRegisterType==1"
      >
        <div slot="icon" class="vant-collapse-icon"></div>
        ...
        <van-cell title="证照" value-class="teadd">
          <one-not-cut
            :one-not-cut="approvalContent.storeList==null?'':approvalContent.storeList[index].bcPicUrl"
            class="notclickadd"
          ></one-not-cut>
        </van-cell>
        <van-field
        ...
        <van-cell title="法人身份证" value-class="teadd">
          <one-not-cut
            :one-not-cut="approvalContent.storeList==null?'':approvalContent.storeList[index].idCardJustUrl"
            class="notclickadd"
          ></one-not-cut>
          <one-not-cut
            :one-not-cut="approvalContent.storeList==null?'':approvalContent.storeList[index].idCardBackUrl"
            class="notclickadd"
          ></one-not-cut>
        </van-cell>
