  ...
  <div class="app-init">
    ...
    <van-collapse v-model="activeNames" class="margintop">
      <van-collapse-item title="基本信息" name="1" value=" " value-class="collapsewarn">
        ...
        <van-field
          type="text"
          label="编码"
          :value="approvalContent.managerSpread==null?'':approvalContent.managerSpread.code"
          readonly
        ></van-field>
        <van-field
          type="text"
    ...
    <van-collapse v-model="activeNames" class="margintop">
      <van-collapse-item name="2" title="状态信息" value-class="collapsewarn">
        ...
        <van-field
          type="text"
          label="上级省区总"
          :value="approvalContent.managerSpread.merManager.managerCooperation.merManager.name"
          v-if="approvalContent.managerSpread && approvalContent.managerSpread.merManager && approvalContent.managerSpread.merManager.managerCooperation && approvalContent.managerSpread.merManager.managerCooperation.merManager"
          readonly
        />
        <van-field
          type="text"
          label="所属合作商"
          v-if="!!approvalContent.managerSpread && !!approvalContent.managerSpread.merManager"
          :value="approvalContent.managerSpread.merManager.name"
          readonly
        />
        <van-field
                type="text"
                style="margin-left:12px;"
                v-if="approvalContentSuccess!=null && approvalContentSuccess.managerSpread != null && change(approvalContent.managerSpread.merManager.name,approvalContentSuccess.managerSpread.merManager.name)"
                :value="'变更前：'+(approvalContentSuccess.managerSpread==null?'':(approvalContentSuccess.managerSpread.merManager.name))"
                readonly
                error
        />
        <van-cell
        ...
        <van-field
                type="text"
                style="margin-left:12px;"
                v-if="approvalContentSuccess!=null && approvalContentSuccess.managerSpread != null && change(approvalContent.managerSpread.type,approvalContentSuccess.managerSpread.type)"
                :value="'变更前：'+(approvalContentSuccess.managerSpread==null?'':(approvalContentSuccess.managerSpread.type==1?'兼职':'专职'))"
                readonly
                error
        />
      </van-collapse-item>
    ...
    <van-collapse v-model="activeNames" class="margintop">
      <van-collapse-item name="3" title="基本信息" value-class="collapsewarn">
        ...
        <van-cell
          ...
          :value="approvalContent.managerSpread==null?'':(approvalContent.managerSpread.areaHomeProvince+approvalContent.managerSpread.areaHomeCity+approvalContent.managerSpread.areaHomeRegion)"
          disabled
        ></van-cell>
        <!-- <van-field
          type="text"
          label=""
          v-if="approvalContentSuccess!=null && approvalContentSuccess.managerSpread != null && approvalContentSuccess.managerSpread.areaHomeProvince != null && change(approvalContent.managerSpread.areaHomeRegion,approvalContentSuccess.managerSpread.areaHomeRegion)"
          :value="'变更前：'+(approvalContentSuccess.managerSpread==null?'':(approvalContentSuccess.managerSpread.areaHomeProvince+approvalContentSuccess.managerSpread.areaHomeCity+approvalContentSuccess.managerSpread.areaHomeRegion))"
          readonly
          error
        /> -->
        <van-field
        ...
        <van-field
          type="text"
          style="margin-left:12px;"
          v-if="approvalContentSuccess!=null && approvalContentSuccess.managerSpread != null && change(approvalContent.managerSpread.address,approvalContentSuccess.managerSpread.address)"
    ...
    <van-collapse v-model="activeNames" class="margintop">
      <van-collapse-item name="4" title="证照信息" value-class="collapsewarn">
        ...
        <van-cell title="" value-class="teadd" v-if="approvalContentSuccess!=null && approvalContentSuccess.managerSpread!=null && approvalContent.managerSpread!=null && (change(approvalContent.managerSpread.idCardBackUrl,approvalContentSuccess.managerSpread.idCardBackUrl) || change(approvalContent.managerSpread==null?'':approvalContent.managerSpread.idCardJustUrl,approvalContentSuccess.managerSpread==null?'':approvalContentSuccess.managerSpread.idCardJustUrl))">
          <p style="color:#f44">变更前：</p>
          <one-not-cut :one-not-cut="approvalContentSuccess.managerSpread==null?'':approvalContentSuccess.managerSpread.idCardBackUrl" class="notclickadd"></one-not-cut>
          <one-not-cut :one-not-cut="approvalContentSuccess.managerSpread==null?'':approvalContentSuccess.managerSpread.idCardJustUrl" class="notclickadd"></one-not-cut>
        </van-cell>
      </van-collapse-item>
    </van-collapse>
